function loadMNIST(callback) {
  let mnist = {};
  let files = {
    train_images: '/ysa-mnist/train-images-idx3-ubyte',
    train_labels: '/ysa-mnist/train-labels-idx1-ubyte',
    test_images: '/ysa-mnist/t10k-images-idx3-ubyte',
    test_labels: '/ysa-mnist/t10k-labels-idx1-ubyte',
  };
